...
#ifndef VPNSETTINGSPLUGIN_H
#define VPNSETTINGSPLUGIN_H
...
public:
    ...
    QString id() { return "vpn";}
    QString title() { return tr("VPN");}
    QString description() { return m_description;}
    QString qmlPath() { return "/usr/share/glacier-settings/plugins/vpn/vpn.qml";}
    QString icon() { return "/usr/share/glacier-settings/plugins/vpn/vpn.svg";}
